...
public class DuckPropertiesTest extends DuckActionClient {
    ...
    @Test(description = "Проверка свойств утки (нечётный ID)", dataProvider = "ducksList")
    @CitrusTest
    @CitrusParameters({"properties", "expectedResponse", "runner"})
    public void getOddDuckProperties(DuckCreate properties, DuckCreateResponse expectedResponse, @Optional @CitrusResource TestCaseRunner runner) {
        ...
        databaseUpdate(runner,
                "INSERT INTO DUCK (id, color, height, material, sound, wings_state) " +
                        "VALUES (${duckId}, '" + properties.color() + "', " + properties.height() + ", '" + properties.material() + "', '" + properties.sound() + "', '" + properties.wingsState() + "')");
    ...
    @Test(description = "Проверка свойств утки (чётный ID)", dataProvider = "ducksList")
    @CitrusTest
    @CitrusParameters({"properties", "expectedResponse", "runner"})
    public void getEvenDuckProperties(DuckCreate properties, DuckCreateResponse expectedResponse, @Optional @CitrusResource TestCaseRunner runner) {
